# Screen Specification: _a-0000e430-f270-8000-9bbc-011c48011c48_337444.xml

## Screen Overview
- **Purpose:** User interface component
- **Source File:** `content/_a-0000e430-f270-8000-9bbc-011c48011c48_337444.xml`
- **Component Count:** 1
...
|----------|----------------|
| local!countOfUsedOnOtherRequestsAsRequiredDoc | Local action variable or clipboard page |
| local!i18nData | Local action variable or clipboard page |
| local!isAttachedToOtherOnboardings | Local action variable or clipboard page |
| local!isUsedOnOtherRequestsAsRequiredDoc | Local action variable or clipboard page |
