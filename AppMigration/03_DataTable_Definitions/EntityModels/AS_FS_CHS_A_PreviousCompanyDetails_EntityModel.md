# Entity Model: AS_FS_CHS_A_PreviousCompanyDetails
...
- **Field Count**: 7
- **Pega Target Class**: `Data-AS-FS-CHS-A-PreviousCompanyDetails`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | previousCompanyDetailsAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | companyDetailsAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 3 | previousCompanyDetailsId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_CHS_A_PreviousCompanyDetails`
