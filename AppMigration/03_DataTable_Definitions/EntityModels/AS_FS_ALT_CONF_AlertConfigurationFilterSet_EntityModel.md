# Entity Model: AS_FS_ALT_CONF_AlertConfigurationFilterSet
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-FS-ALT-CONF-AlertConfigurationFilterSet`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | alertConfigurationFilterSetId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_ALT_CONF_AlertConfigurationFilterSet`
