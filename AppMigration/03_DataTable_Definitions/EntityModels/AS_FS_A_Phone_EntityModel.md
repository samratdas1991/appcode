...
- **Field Count**: 7
- **Pega Target Class**: `Data-AS-FS-A-Phone`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | phoneAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | contactAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 3 | phoneId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_A_Phone`
