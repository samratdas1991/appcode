# Entity Model: AS_QNM_A_Questionnaire
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-QNM-A-Questionnaire`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | questionnaireAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | questionnaireId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_QNM_A_Questionnaire`
