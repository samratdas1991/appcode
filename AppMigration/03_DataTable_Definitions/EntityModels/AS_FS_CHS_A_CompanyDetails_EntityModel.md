# Entity Model: AS_FS_CHS_A_CompanyDetails
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-FS-CHS-A-CompanyDetails`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | companyDetailsAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | companyDetailsId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_CHS_A_CompanyDetails`
