# Entity Model: AS_IO_A_R_TaskCategory
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-IO-A-R-TaskCategory`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | taskCategoryAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | taskCategoryId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_A_R_TaskCategory`
