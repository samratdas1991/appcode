# Entity Model: AS_IO_A_T_OnboardingProduct
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-IO-A-T-OnboardingProduct`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | onboardingProductTemplateAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | onboardingProductTemplateId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_A_T_OnboardingProduct`
