# Entity Model: AS_IO_R_OnboardingType_ProductType_Mapping
...
- **Field Count**: 8
- **Pega Target Class**: `Data-AS-IO-R-OnboardingType-ProductType-Mapping`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | onboardingTypeProductTypeMappingId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | onboardingTypeCode | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_R_OnboardingType_ProductType_Mapping`
