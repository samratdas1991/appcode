# Entity Model: AS_QNM_A_T_Questionnaire
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-QNM-A-T-Questionnaire`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | questionnaireTemplateAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_QNM_A_T_Questionnaire`
