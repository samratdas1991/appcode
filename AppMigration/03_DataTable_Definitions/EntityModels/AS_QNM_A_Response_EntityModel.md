# Entity Model: AS_QNM_A_Response
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-QNM-A-Response`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | responseAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | responseId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_QNM_A_Response`
