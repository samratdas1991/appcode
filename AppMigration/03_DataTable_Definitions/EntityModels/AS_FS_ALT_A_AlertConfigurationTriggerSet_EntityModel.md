# Entity Model: AS_FS_ALT_A_AlertConfigurationTriggerSet
...
- **Field Count**: 5
- **Pega Target Class**: `Data-AS-FS-ALT-A-AlertConfigurationTriggerSet`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | alertConfigurationTriggerSetAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_ALT_A_AlertConfigurationTriggerSet`
