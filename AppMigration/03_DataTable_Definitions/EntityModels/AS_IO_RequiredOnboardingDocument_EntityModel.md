# Entity Model: AS_IO_RequiredOnboardingDocument
...
- **Field Count**: 10
- **Pega Target Class**: `Data-AS-IO-RequiredOnboardingDocument`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | requiredOnboardingDocumentId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | requestId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 3 | docTypeCode | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 4 | requirementName | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 5 | onboardingDocument | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_RequiredOnboardingDocument`
