...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-FS-A-Country`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | countryAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | countryId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_A_Country`
