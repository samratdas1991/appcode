# Entity Model: AS_FS_A_Pay_Threshold
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-FS-A-Pay-Threshold`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | payThresholdAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | payThresholdId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_A_Pay_Threshold`
