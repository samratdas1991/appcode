# Entity Model: AS_IO_A_OnboardingRequest_Field
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-IO-A-OnboardingRequest-Field`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | onboardingAuditFieldId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | onboardingAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_A_OnboardingRequest_Field`
