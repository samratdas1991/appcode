# Entity Model: AS_QNM_A_T_QuestionPrecedentSet
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-QNM-A-T-QuestionPrecedentSet`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | questionPrecedentSetAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | questionPrecedentSetTemplateId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_QNM_A_T_QuestionPrecedentSet`
