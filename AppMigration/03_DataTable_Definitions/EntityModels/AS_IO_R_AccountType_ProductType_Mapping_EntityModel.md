# Entity Model: AS_IO_R_AccountType_ProductType_Mapping
...
- **Field Count**: 8
- **Pega Target Class**: `Data-AS-IO-R-AccountType-ProductType-Mapping`
...
- Map to database table `AS_IO_R_AccountType_ProductType_Mapping`
