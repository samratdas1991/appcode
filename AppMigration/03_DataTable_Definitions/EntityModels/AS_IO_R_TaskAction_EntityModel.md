# Entity Model: AS_IO_R_TaskAction
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-IO-R-TaskAction`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | taskActionId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | actionDisplayName | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_R_TaskAction`
