# Entity Model: AS_QNM_A_T_QuestionCategory
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-QNM-A-T-QuestionCategory`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | questionCategoryTemplateAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | questionCategoryTemplateId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_QNM_A_T_QuestionCategory`
