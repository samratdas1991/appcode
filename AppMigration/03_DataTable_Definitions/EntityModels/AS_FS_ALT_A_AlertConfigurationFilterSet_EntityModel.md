# Entity Model: AS_FS_ALT_A_AlertConfigurationFilterSet
...
- **Field Count**: 5
- **Pega Target Class**: `Data-AS-FS-ALT-A-AlertConfigurationFilterSet`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | alertConfigurationFilterSetAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_ALT_A_AlertConfigurationFilterSet`
