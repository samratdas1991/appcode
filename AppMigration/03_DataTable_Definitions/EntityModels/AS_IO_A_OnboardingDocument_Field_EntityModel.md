# Entity Model: AS_IO_A_OnboardingDocument_Field
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-IO-A-OnboardingDocument-Field`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | onboardingDocumentAuditFieldId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | onboardingDocumentAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_A_OnboardingDocument_Field`
