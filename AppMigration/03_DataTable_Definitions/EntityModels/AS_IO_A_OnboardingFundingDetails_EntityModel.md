# Entity Model: AS_IO_A_OnboardingFundingDetails
...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-IO-A-OnboardingFundingDetails`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | fundingDetailsAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
| 2 | fundingDetailsId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_IO_A_OnboardingFundingDetails`
