# Entity Model: AS_QNM_T_Response
...
- **Field Count**: 4
- **Pega Target Class**: `Data-AS-QNM-T-Response`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | responseTemplateId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_QNM_T_Response`
