# Entity Model: AS_IO_R_ProductTypeFieldMapping
...
- **Field Count**: 7
- **Pega Target Class**: `Data-AS-IO-R-ProductTypeFieldMapping`
...
- Map to database table `AS_IO_R_ProductTypeFieldMapping`
