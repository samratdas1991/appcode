...
- **Field Count**: 6
- **Pega Target Class**: `Data-AS-FS-A-Product`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | productAuditId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
| 6 | termChange | tns:AS_FS_A_Term | VARCHAR(255) | Text | Yes | Single value |

## Pega Implementation Notes

- Create as Pega Data Type class under appropriate application layer
- Map to database table `AS_FS_A_Product`
