# Entity Model: AS_FS_A_Contact_Field
...
- **Field Count**: 5
- **Pega Target Class**: `Data-AS-FS-A-Contact-Field`

## Field Definitions

| # | Field Name | Appian Type | SQL Type | Pega Type | Required | Notes |
|---|-----------|-------------|----------|-----------|----------|-------|
| 1 | contactAuditFieldId | xsd:string | VARCHAR(255) | Text | Yes | Single value |
...
- Map to database table `AS_FS_A_Contact_Field`
