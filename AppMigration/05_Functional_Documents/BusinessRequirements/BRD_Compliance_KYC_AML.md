# Business Requirements Document - Compliance KYC AML

**Application:** Appian Financial Services Onboarding Platform  
**Module:** Compliance KYC AML  
...
This document captures the business requirements for the **Compliance KYC AML** module. These requirements are derived from 1 Appian process models and their associated data types, integrations, and interfaces.

## 2. Business Objectives

- Automate KYC/AML screening and verification
- Integrate with external compliance data providers
- Maintain audit trail for all compliance activities
- Support configurable risk scoring and escalation

## 3. Functional Requirements

| ID | Description | Source Appian Process | Priority | Pega Implementation |
|---|---|---|---|---|
| FR-COM-001 | AS IO Update Initial KYC Screening | 0000e537-e3b4-8000-1c2f-7f0000014e7a.xml | High | Case Type with User Assignments + Decision shapes |
